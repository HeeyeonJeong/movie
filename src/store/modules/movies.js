...
const GET_GENRE_MOVIES = "genreMovies/GET_GENRE_MOVIES";
const GET_GENRE_MOVIES_SUCCESS = "genreMovies/GET_GENRE_MOVIES_SUCCESS";
const GET_GENRE_MOVIES_ERROR = "genreMovies/GET_GENRE_MOVIES_ERROR";
